...
export const Features = () => {
  return (
    <div className="max-w-6xl mx-auto p-6 lg:py-40">
        ...
        <p className="max-w-lg mt-5 lg:mt-10 lg:mb-16 text-xl">We are all about our clients comform and safety. Thats why we provide the best service you can image </p>
