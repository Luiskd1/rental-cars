      ...
      <div className="grid md:grid-cols-2 gap-6 lg:grid-cols-4">
        {cars.map((car: Car) => {
          ...
          return (
              ...
              >
                <Image src={photo} alt="" width={400} height={600} />
              <div className="p-3">
                ...
                ?(<div className="flex items-center justify-center gap-x-3">
                    ...
                    <Heart className={`mt-2 cursor-pointer ${likedCar? "fill-red-600" : ""}`}
                ...
                (
                    <div className="w-full mt-2 text-center">
                        <Link href={"/sign-in"}>
                            <Button className="w-full" variant={"outline"}>Inicia sesion para reservar</Button>
                        </Link>
                    </div>
                )
                }
